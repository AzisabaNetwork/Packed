...
internal class AsyncPlayerConnectionConfigureListener(private val resourcePackRequest: ResourcePackRequest) : Listener {
    @EventHandler
    fun onAsyncPlayerConnectionConfigureEvent(event: AsyncPlayerConnectionConfigureEvent) {
        event.connection.audience.sendResourcePacks(resourcePackRequest)
    }
}
